...
@Named
@RequestScoped //Para quando usa tabela com dados informativos sem link para outras paginas
public class RelatorioEntradaSaidaBean implements Serializable{
	...
	public String gerarRelatoio() {
		try {
			acessos = alunoService.listaAcessosAlunos(matricula, dataInicial, dataFinal);
